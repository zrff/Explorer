...
//              image.setRGB(x, y,  (matrix.get(x, y) ? Color.YELLOW.getRGB() : Color.CYAN.getRGB()));
     ...
     * @param height  高
     */
    public static void writeToStream(String content,OutputStream stream, int width, int height,String logoURL) throws WriterException, IOException {
        BitMatrix bitMatrix = new MultiFormatWriter().encode(content, BarcodeFormat.QR_CODE, width, height, hints);
...
//        OutputStream outputStream=new FileOutputStream(new File("/home/darling/Desktop/hello.jpg"));
//        QRCodeUtil.writeToStream("www.baidu.com",outputStream,width,height);
        QRCodeUtil.createQRCode("http://www.baidu.com","/home/darling/Desktop/qunar.png",width,height);
    }
}